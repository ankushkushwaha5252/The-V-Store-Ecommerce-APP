        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="text-right">
            <button 
              ...
              className="text-xs font-bold text-rose-gold hover:underline"
            >
          ...
          >
            {isLoading ? (view === 'login' ? 'Signing in...' : 'Sending...') : (view === 'login' ? 'Sign In' : 'Send Reset Link')}
        ...
        <div className="mt-10 text-center">
          <p className="text-gray-500 text-sm">
            {view === 'login' ? (
              ...
              <button onClick={() => setView('login')} className="font-bold text-rose-gold hover:underline">
                Back to Login
              </button>
            )}
          </p>
